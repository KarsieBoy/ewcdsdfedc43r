...
.addFields(
  ...
  { name: 'Online:', value: `${msg.guild.memberscache.filter(member => member.presence.status !== "offline").size}`, inline: true },
...
.addFields(
  ...
  { name: 'Rollen:', value: `<@&709132913676910592> <@&709125249496515003> <@&709131676520808530>\n <@&709131677460463628> <@&780875829453258762> <@&748092364865929319>ㅤ ㅤㅤㅤ  `, inline: false },
)
